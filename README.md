...
```
Private key is generated from bytes or passphrases. Then create address and search in txt file address with balance, if it's succsesfull it will be saved in WIN.txt.
